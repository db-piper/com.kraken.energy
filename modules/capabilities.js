...
const GAS_TARIFF = {
  ...
  CHUNK_ENERGY: "meter_power.chunk_consumption",
  CHUNK_VALUE: "measure_monetary.chunk_consumption_value",
};
...
const SMART_ENERGY_DEVICE = {
  ...
  PLANNED_ENERGY_TOTAL: "meter_power.energy_planned_total",
  PLAN_END_TIME: "date_time.plan_end_time",
  ...
  CURRENT_DISPATCH_ENERGY: "meter_power.energy_current_dispatch",
